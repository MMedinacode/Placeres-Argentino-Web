/* ============================================================
   PLACERES ARGENTINO — datos y lógica
   ============================================================
   ⚠️ SIN PRECIOS. No publican carta con precios en ningún canal y Google
   tampoco recoge un rango de gasto. Los productos listados son los que se
   IDENTIFICAN EN SUS PROPIAS FOTOS de la vitrina: cañoncitos, medialunas,
   pastafrola, alfajores de maicena y las tinas de helado. Ninguno
   inventado. Pedirle la carta al local para cargar precios y sabores.
   ============================================================ */

const MENU = {
  "pasteleria": {
    "label": "Pastelería argentina",
    "items": [
      {
        "n": "Cañoncitos de dulce de leche",
        "d": "Masa de hojaldre rellena y espolvoreada — fotografiados en su vitrina",
        "img": "vitrina.jpg"
      },
      {
        "n": "Medialunas",
        "d": "Fotografiadas en su vitrina"
      },
      {
        "n": "Pastafrola",
        "d": "La tarta enrejada clásica — fotografiada en su vitrina"
      },
      {
        "n": "Alfajores de maicena",
        "d": "Fotografiados en su vitrina"
      },
      {
        "n": "Facturas surtidas",
  ...
  "heladeria": {
    ...
    "items": [
      {
        "n": "Helados artesanales",
        "d": "Vitrina propia con las tinas a la vista — fotografiada en el local",
        "img": "helados.jpg"
      }
    ]
  }
...
/* ---------- INDICADOR ABIERTO / CERRADO ----------
   ⚠️ Google confirma que CIERRA a las 22:00. La hora de apertura NO está publicada: se asume 10:00 como estimación y así se declara en Visítanos. */
